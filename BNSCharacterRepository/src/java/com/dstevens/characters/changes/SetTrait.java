...
public abstract class SetTrait {
    ...
    public final BNSPlayerCharacter approve(BNSPlayerCharacter character) {
        return status.apply(character, this);
    }
    
    public final BNSPlayerCharacter deny(BNSPlayerCharacter character) {
    ...
    public abstract BNSPlayerCharacter apply(BNSPlayerCharacter character);
    public abstract BNSPlayerCharacter remove(BNSPlayerCharacter character);
